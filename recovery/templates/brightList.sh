...
#############################################################################
# NAME: brightList.sh
# Description: Get a list of files from a given path avoiding find command and 
#             ls command with lock options such as ls -l.
# Date: May/17/2016
# Version: 1.1
#############################################################################
...
### --- SETTINGS -------------------------------
### ----To Make it Remote Executable  ----------
### --- comment these lines for normal usage ---
DEBUG=1
dirTarget="{REMOTE_DIR_TARGET}" # Path in remote server
outputFile="{REMOTE_FILE_PATH}" # File in remote server 
###  -------------------------------------------
###  -------------------------------------------
